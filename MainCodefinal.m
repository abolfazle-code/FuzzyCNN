...
numimg = 150
tic
[error] = errorfunction(I,rand(1,629),[ones(1,80),-1*ones(1,70)],fism,numimg)
toc
%%
%training
CostFunction = @(x) errorfunction(I,x,[ones(1,80),-1*ones(1,70)],fism,numimg);          % @ Cost Function
nV = 629;                         % Number of variables;
Vmin = [zeros(1,5), -10 *ones(1,128),-1 *ones(1,8),zeros(1,8),-1 *ones(1,16),zeros(1,16),-1 *ones(1,32),zeros(1,32),-1 *ones(1,64),zeros(1,64),-1 *ones(1,128),zeros(1,128)];        % Lower bound of variable;
